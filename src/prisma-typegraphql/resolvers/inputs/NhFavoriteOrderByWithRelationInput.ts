...
@TypeGraphQL.InputType("NhFavoriteOrderByWithRelationInput", {
  isAbstract: true
})
export class NhFavoriteOrderByWithRelationInput {
  ...
  author?: NhAuthorOrderByWithRelationInput | undefined;
