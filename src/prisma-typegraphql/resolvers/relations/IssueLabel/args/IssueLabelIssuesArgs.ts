...
export class IssueLabelIssuesArgs {
  ...
  distinct?: Array<"id" | "userId" | "position" | "solvedPosition" | "title" | "solution" | "isSolved" | "solvedAt" | "frequency" | "intensity" | "createdAt" | "updatedAt"> | undefined;
}
