...
export class ExpenseCrudResolver {
  ...
  async createOneExpense(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: CreateOneExpenseArgs): Promise<Expense> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteOneExpense(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: DeleteOneExpenseArgs): Promise<Expense | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findFirstExpenseOrThrow(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindFirstExpenseOrThrowArgs): Promise<Expense | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async getExpense(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindUniqueExpenseOrThrowArgs): Promise<Expense | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async updateOneExpense(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpdateOneExpenseArgs): Promise<Expense | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async upsertOneExpense(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpsertOneExpenseArgs): Promise<Expense> {
    const { _count } = transformInfoIntoPrismaArgs(info);
