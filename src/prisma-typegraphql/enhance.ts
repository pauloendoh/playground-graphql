...
const crudResolversMap = {
  ...
  NhAuthor: crudResolvers.NhAuthorCrudResolver,
  NhFavorite: crudResolvers.NhFavoriteCrudResolver
};
const actionResolversMap = {
  ...
  NhAuthor: {
    aggregateNhAuthor: actionResolvers.AggregateNhAuthorResolver,
    createManyNhAuthor: actionResolvers.CreateManyNhAuthorResolver,
    createOneNhAuthor: actionResolvers.CreateOneNhAuthorResolver,
    deleteManyNhAuthor: actionResolvers.DeleteManyNhAuthorResolver,
    deleteOneNhAuthor: actionResolvers.DeleteOneNhAuthorResolver,
    findFirstNhAuthor: actionResolvers.FindFirstNhAuthorResolver,
    findFirstNhAuthorOrThrow: actionResolvers.FindFirstNhAuthorOrThrowResolver,
    nhAuthors: actionResolvers.FindManyNhAuthorResolver,
    nhAuthor: actionResolvers.FindUniqueNhAuthorResolver,
    getNhAuthor: actionResolvers.FindUniqueNhAuthorOrThrowResolver,
    groupByNhAuthor: actionResolvers.GroupByNhAuthorResolver,
    updateManyNhAuthor: actionResolvers.UpdateManyNhAuthorResolver,
    updateOneNhAuthor: actionResolvers.UpdateOneNhAuthorResolver,
    upsertOneNhAuthor: actionResolvers.UpsertOneNhAuthorResolver
  },
  NhFavorite: {
    aggregateNhFavorite: actionResolvers.AggregateNhFavoriteResolver,
    createManyNhFavorite: actionResolvers.CreateManyNhFavoriteResolver,
    createOneNhFavorite: actionResolvers.CreateOneNhFavoriteResolver,
    deleteManyNhFavorite: actionResolvers.DeleteManyNhFavoriteResolver,
    deleteOneNhFavorite: actionResolvers.DeleteOneNhFavoriteResolver,
    findFirstNhFavorite: actionResolvers.FindFirstNhFavoriteResolver,
    findFirstNhFavoriteOrThrow: actionResolvers.FindFirstNhFavoriteOrThrowResolver,
    nhFavorites: actionResolvers.FindManyNhFavoriteResolver,
    nhFavorite: actionResolvers.FindUniqueNhFavoriteResolver,
    getNhFavorite: actionResolvers.FindUniqueNhFavoriteOrThrowResolver,
    groupByNhFavorite: actionResolvers.GroupByNhFavoriteResolver,
    updateManyNhFavorite: actionResolvers.UpdateManyNhFavoriteResolver,
    updateOneNhFavorite: actionResolvers.UpdateOneNhFavoriteResolver,
    upsertOneNhFavorite: actionResolvers.UpsertOneNhFavoriteResolver
  }
};
const crudResolversInfo = {
  ...
  NhAuthor: ["aggregateNhAuthor", "createManyNhAuthor", "createOneNhAuthor", "deleteManyNhAuthor", "deleteOneNhAuthor", "findFirstNhAuthor", "findFirstNhAuthorOrThrow", "nhAuthors", "nhAuthor", "getNhAuthor", "groupByNhAuthor", "updateManyNhAuthor", "updateOneNhAuthor", "upsertOneNhAuthor"],
  NhFavorite: ["aggregateNhFavorite", "createManyNhFavorite", "createOneNhFavorite", "deleteManyNhFavorite", "deleteOneNhFavorite", "findFirstNhFavorite", "findFirstNhFavoriteOrThrow", "nhFavorites", "nhFavorite", "getNhFavorite", "groupByNhFavorite", "updateManyNhFavorite", "updateOneNhFavorite", "upsertOneNhFavorite"]
};
const argsInfo = {
  ...
  AggregateNhAuthorArgs: ["where", "orderBy", "cursor", "take", "skip"],
  CreateManyNhAuthorArgs: ["data", "skipDuplicates"],
  CreateOneNhAuthorArgs: ["data"],
  DeleteManyNhAuthorArgs: ["where"],
  DeleteOneNhAuthorArgs: ["where"],
  FindFirstNhAuthorArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindFirstNhAuthorOrThrowArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyNhAuthorArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindUniqueNhAuthorArgs: ["where"],
  FindUniqueNhAuthorOrThrowArgs: ["where"],
  GroupByNhAuthorArgs: ["where", "orderBy", "by", "having", "take", "skip"],
  UpdateManyNhAuthorArgs: ["data", "where"],
  UpdateOneNhAuthorArgs: ["data", "where"],
  UpsertOneNhAuthorArgs: ["where", "create", "update"],
  AggregateNhFavoriteArgs: ["where", "orderBy", "cursor", "take", "skip"],
  CreateManyNhFavoriteArgs: ["data", "skipDuplicates"],
  CreateOneNhFavoriteArgs: ["data"],
  DeleteManyNhFavoriteArgs: ["where"],
  DeleteOneNhFavoriteArgs: ["where"],
  FindFirstNhFavoriteArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindFirstNhFavoriteOrThrowArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyNhFavoriteArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindUniqueNhFavoriteArgs: ["where"],
  FindUniqueNhFavoriteOrThrowArgs: ["where"],
  GroupByNhFavoriteArgs: ["where", "orderBy", "by", "having", "take", "skip"],
  UpdateManyNhFavoriteArgs: ["data", "where"],
  UpdateOneNhFavoriteArgs: ["data", "where"],
  UpsertOneNhFavoriteArgs: ["where", "create", "update"]
};
...
const relationResolversMap = {
  ...
  NhAuthor: relationResolvers.NhAuthorRelationsResolver,
  NhFavorite: relationResolvers.NhFavoriteRelationsResolver
};
const relationResolversInfo = {
  User: ["recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  Recipe: ["user"],
  Saving: ["user"],
  WishlistItem: ["user"],
  ...
  NhAuthor: ["user", "favorites"],
  NhFavorite: ["author", "user"]
};
...
const modelsInfo = {
  ...
  Saving: ["id", "userId", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  WishlistItem: ["id", "userId", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  ...
  NhAuthor: ["url", "userId", "checkedAt", "createdAt", "updatedAt"],
  NhFavorite: ["url", "authorUrl", "userId"]
};
...
const outputsInfo = {
  ...
  SavingGroupBy: ["id", "userId", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateWishlistItem: ["_count", "_avg", "_sum", "_min", "_max"],
  WishlistItemGroupBy: ["id", "userId", "itemName", "priceInThousands", "price", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  AggregateNhAuthor: ["_count", "_min", "_max"],
  NhAuthorGroupBy: ["url", "userId", "checkedAt", "createdAt", "updatedAt", "_count", "_min", "_max"],
  AggregateNhFavorite: ["_count", "_min", "_max"],
  NhFavoriteGroupBy: ["url", "authorUrl", "userId", "_count", "_min", "_max"],
  AffectedRowsOutput: ["count"],
  UserCount: ["recipe", "savings", "wishlistItems", "expenses", "categories", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  ...
  SavingCountAggregate: ["id", "userId", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt", "_all"],
  SavingAvgAggregate: ["value"],
  SavingSumAggregate: ["value"],
  SavingMinAggregate: ["id", "userId", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  SavingMaxAggregate: ["id", "userId", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  WishlistItemCountAggregate: ["id", "userId", "itemName", "priceInThousands", "price", "createdAt", "updatedAt", "_all"],
  WishlistItemAvgAggregate: ["priceInThousands", "price"],
  WishlistItemSumAggregate: ["priceInThousands", "price"],
  WishlistItemMinAggregate: ["id", "userId", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  WishlistItemMaxAggregate: ["id", "userId", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  ...
  NhAuthorCount: ["favorites"],
  NhAuthorCountAggregate: ["url", "userId", "checkedAt", "createdAt", "updatedAt", "_all"],
  NhAuthorMinAggregate: ["url", "userId", "checkedAt", "createdAt", "updatedAt"],
  NhAuthorMaxAggregate: ["url", "userId", "checkedAt", "createdAt", "updatedAt"],
  NhFavoriteCountAggregate: ["url", "authorUrl", "userId", "_all"],
  NhFavoriteMinAggregate: ["url", "authorUrl", "userId"],
  NhFavoriteMaxAggregate: ["url", "authorUrl", "userId"]
};
...
const inputsInfo = {
  UserWhereInput: ["AND", "OR", "NOT", "id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  UserOrderByWithRelationInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  ...
  SavingWhereInput: ["AND", "OR", "NOT", "id", "userId", "user", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  SavingOrderByWithRelationInput: ["id", "userId", "user", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  SavingWhereUniqueInput: ["id"],
  SavingOrderByWithAggregationInput: ["id", "userId", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt", "_count", "_avg", "_max", "_min", "_sum"],
  SavingScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "userId", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  WishlistItemWhereInput: ["AND", "OR", "NOT", "id", "userId", "user", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  WishlistItemOrderByWithRelationInput: ["id", "userId", "user", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  WishlistItemWhereUniqueInput: ["id"],
  WishlistItemOrderByWithAggregationInput: ["id", "userId", "itemName", "priceInThousands", "price", "createdAt", "updatedAt", "_count", "_avg", "_max", "_min", "_sum"],
  WishlistItemScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "userId", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  ...
  NhAuthorWhereInput: ["AND", "OR", "NOT", "url", "userId", "user", "checkedAt", "createdAt", "updatedAt", "favorites"],
  NhAuthorOrderByWithRelationInput: ["url", "userId", "user", "checkedAt", "createdAt", "updatedAt", "favorites"],
  NhAuthorWhereUniqueInput: ["url"],
  NhAuthorOrderByWithAggregationInput: ["url", "userId", "checkedAt", "createdAt", "updatedAt", "_count", "_max", "_min"],
  NhAuthorScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "url", "userId", "checkedAt", "createdAt", "updatedAt"],
  NhFavoriteWhereInput: ["AND", "OR", "NOT", "url", "authorUrl", "author", "userId", "user"],
  NhFavoriteOrderByWithRelationInput: ["url", "authorUrl", "author", "userId", "user"],
  NhFavoriteWhereUniqueInput: ["url"],
  NhFavoriteOrderByWithAggregationInput: ["url", "authorUrl", "userId", "_count", "_max", "_min"],
  NhFavoriteScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "url", "authorUrl", "userId"],
  UserCreateInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  UserUpdateInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  ...
  SavingCreateInput: ["id", "user", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  SavingUpdateInput: ["id", "user", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  SavingCreateManyInput: ["id", "userId", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  SavingUpdateManyMutationInput: ["id", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  WishlistItemCreateInput: ["id", "user", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  WishlistItemUpdateInput: ["id", "user", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  WishlistItemCreateManyInput: ["id", "userId", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  WishlistItemUpdateManyMutationInput: ["id", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  ...
  NhAuthorCreateInput: ["url", "user", "checkedAt", "createdAt", "updatedAt", "favorites"],
  NhAuthorUpdateInput: ["url", "user", "checkedAt", "createdAt", "updatedAt", "favorites"],
  NhAuthorCreateManyInput: ["url", "userId", "checkedAt", "createdAt", "updatedAt"],
  NhAuthorUpdateManyMutationInput: ["url", "checkedAt", "createdAt", "updatedAt"],
  NhFavoriteCreateInput: ["url", "author", "user"],
  NhFavoriteUpdateInput: ["url", "author", "user"],
  NhFavoriteCreateManyInput: ["url", "authorUrl", "userId"],
  NhFavoriteUpdateManyMutationInput: ["url"],
  ...
  NhFavoriteListRelationFilter: ["every", "some", "none"],
  NhAuthorListRelationFilter: ["every", "some", "none"],
  ...
  NhFavoriteOrderByRelationAggregateInput: ["_count"],
  NhAuthorOrderByRelationAggregateInput: ["_count"],
  ...
  SavingCountOrderByAggregateInput: ["id", "userId", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  SavingAvgOrderByAggregateInput: ["value"],
  SavingMaxOrderByAggregateInput: ["id", "userId", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  SavingMinOrderByAggregateInput: ["id", "userId", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  ...
  WishlistItemCountOrderByAggregateInput: ["id", "userId", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  WishlistItemAvgOrderByAggregateInput: ["priceInThousands", "price"],
  WishlistItemMaxOrderByAggregateInput: ["id", "userId", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  WishlistItemMinOrderByAggregateInput: ["id", "userId", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  WishlistItemSumOrderByAggregateInput: ["priceInThousands", "price"],
  ...
  NhAuthorCountOrderByAggregateInput: ["url", "userId", "checkedAt", "createdAt", "updatedAt"],
  NhAuthorMaxOrderByAggregateInput: ["url", "userId", "checkedAt", "createdAt", "updatedAt"],
  NhAuthorMinOrderByAggregateInput: ["url", "userId", "checkedAt", "createdAt", "updatedAt"],
  NhAuthorRelationFilter: ["is", "isNot"],
  NhFavoriteCountOrderByAggregateInput: ["url", "authorUrl", "userId"],
  NhFavoriteMaxOrderByAggregateInput: ["url", "authorUrl", "userId"],
  NhFavoriteMinOrderByAggregateInput: ["url", "authorUrl", "userId"],
  ...
  NhFavoriteCreateNestedManyWithoutUserInput: ["create", "connectOrCreate", "createMany", "connect"],
  NhAuthorCreateNestedManyWithoutUserInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  NhFavoriteUpdateManyWithoutUserNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  NhAuthorUpdateManyWithoutUserNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  UserCreateNestedOneWithoutNhAuthorsInput: ["create", "connectOrCreate", "connect"],
  NhFavoriteCreateNestedManyWithoutAuthorInput: ["create", "connectOrCreate", "createMany", "connect"],
  UserUpdateOneRequiredWithoutNhAuthorsNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  NhFavoriteUpdateManyWithoutAuthorNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  NhAuthorCreateNestedOneWithoutFavoritesInput: ["create", "connectOrCreate", "connect"],
  UserCreateNestedOneWithoutNhFavoritesInput: ["create", "connectOrCreate", "connect"],
  NhAuthorUpdateOneRequiredWithoutFavoritesNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  UserUpdateOneRequiredWithoutNhFavoritesNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ...
  SavingCreateWithoutUserInput: ["id", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  SavingCreateOrConnectWithoutUserInput: ["where", "create"],
  SavingCreateManyUserInputEnvelope: ["data", "skipDuplicates"],
  WishlistItemCreateWithoutUserInput: ["id", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  ...
  NhFavoriteCreateWithoutUserInput: ["url", "author"],
  NhFavoriteCreateOrConnectWithoutUserInput: ["where", "create"],
  NhFavoriteCreateManyUserInputEnvelope: ["data", "skipDuplicates"],
  NhAuthorCreateWithoutUserInput: ["url", "checkedAt", "createdAt", "updatedAt", "favorites"],
  NhAuthorCreateOrConnectWithoutUserInput: ["where", "create"],
  NhAuthorCreateManyUserInputEnvelope: ["data", "skipDuplicates"],
  ...
  SavingScalarWhereInput: ["AND", "OR", "NOT", "id", "userId", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  ...
  WishlistItemScalarWhereInput: ["AND", "OR", "NOT", "id", "userId", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  ...
  NhFavoriteUpsertWithWhereUniqueWithoutUserInput: ["where", "update", "create"],
  NhFavoriteUpdateWithWhereUniqueWithoutUserInput: ["where", "data"],
  NhFavoriteUpdateManyWithWhereWithoutUserInput: ["where", "data"],
  NhFavoriteScalarWhereInput: ["AND", "OR", "NOT", "url", "authorUrl", "userId"],
  NhAuthorUpsertWithWhereUniqueWithoutUserInput: ["where", "update", "create"],
  NhAuthorUpdateWithWhereUniqueWithoutUserInput: ["where", "data"],
  NhAuthorUpdateManyWithWhereWithoutUserInput: ["where", "data"],
  NhAuthorScalarWhereInput: ["AND", "OR", "NOT", "url", "userId", "checkedAt", "createdAt", "updatedAt"],
  UserCreateWithoutRecipeInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  UserCreateOrConnectWithoutRecipeInput: ["where", "create"],
  UserUpsertWithoutRecipeInput: ["update", "create"],
  UserUpdateWithoutRecipeInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  UserCreateWithoutSavingsInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  UserCreateOrConnectWithoutSavingsInput: ["where", "create"],
  UserUpsertWithoutSavingsInput: ["update", "create"],
  UserUpdateWithoutSavingsInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  UserCreateWithoutWishlistItemsInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  UserCreateOrConnectWithoutWishlistItemsInput: ["where", "create"],
  UserUpsertWithoutWishlistItemsInput: ["update", "create"],
  UserUpdateWithoutWishlistItemsInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  UserCreateWithoutExpensesInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  ...
  UserUpdateWithoutExpensesInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  ...
  UserCreateWithoutCategoriesInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  ...
  UserUpdateWithoutCategoriesInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  ...
  UserCreateWithoutSalaryInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  UserCreateOrConnectWithoutSalaryInput: ["where", "create"],
  UserUpsertWithoutSalaryInput: ["update", "create"],
  UserUpdateWithoutSalaryInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  UserCreateWithoutIssuesInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  ...
  UserUpdateWithoutIssuesInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  ...
  UserCreateWithoutIssueLabelsInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  ...
  UserUpdateWithoutIssueLabelsInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "rawColors", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  ...
  UserCreateWithoutRawColorsInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  ...
  UserUpdateWithoutRawColorsInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "mixedColors", "colorProportions", "nhFavorites", "nhAuthors"],
  ...
  UserCreateWithoutMixedColorsInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "colorProportions", "nhFavorites", "nhAuthors"],
  ...
  UserUpdateWithoutMixedColorsInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "colorProportions", "nhFavorites", "nhAuthors"],
  ...
  UserCreateWithoutColorProportionsInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "nhFavorites", "nhAuthors"],
  ...
  UserUpdateWithoutColorProportionsInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "nhFavorites", "nhAuthors"],
  ...
  UserCreateWithoutNhAuthorsInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites"],
  UserCreateOrConnectWithoutNhAuthorsInput: ["where", "create"],
  NhFavoriteCreateWithoutAuthorInput: ["url", "user"],
  NhFavoriteCreateOrConnectWithoutAuthorInput: ["where", "create"],
  NhFavoriteCreateManyAuthorInputEnvelope: ["data", "skipDuplicates"],
  UserUpsertWithoutNhAuthorsInput: ["update", "create"],
  UserUpdateWithoutNhAuthorsInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhFavorites"],
  NhFavoriteUpsertWithWhereUniqueWithoutAuthorInput: ["where", "update", "create"],
  NhFavoriteUpdateWithWhereUniqueWithoutAuthorInput: ["where", "data"],
  NhFavoriteUpdateManyWithWhereWithoutAuthorInput: ["where", "data"],
  NhAuthorCreateWithoutFavoritesInput: ["url", "user", "checkedAt", "createdAt", "updatedAt"],
  NhAuthorCreateOrConnectWithoutFavoritesInput: ["where", "create"],
  UserCreateWithoutNhFavoritesInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhAuthors"],
  UserCreateOrConnectWithoutNhFavoritesInput: ["where", "create"],
  NhAuthorUpsertWithoutFavoritesInput: ["update", "create"],
  NhAuthorUpdateWithoutFavoritesInput: ["url", "user", "checkedAt", "createdAt", "updatedAt"],
  UserUpsertWithoutNhFavoritesInput: ["update", "create"],
  UserUpdateWithoutNhFavoritesInput: ["id", "username", "email", "password", "createdAt", "updatedAt", "recipe", "savings", "wishlistItems", "expenses", "categories", "salary", "issues", "issueLabels", "rawColors", "mixedColors", "colorProportions", "nhAuthors"],
  RecipeCreateManyUserInput: ["id", "title", "description", "rating", "savedPosition", "createdAt", "updatedAt"],
  SavingCreateManyUserInput: ["id", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  WishlistItemCreateManyUserInput: ["id", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  ...
  NhFavoriteCreateManyUserInput: ["url", "authorUrl"],
  NhAuthorCreateManyUserInput: ["url", "checkedAt", "createdAt", "updatedAt"],
  RecipeUpdateWithoutUserInput: ["id", "title", "description", "rating", "savedPosition", "createdAt", "updatedAt"],
  SavingUpdateWithoutUserInput: ["id", "value", "date", "selectedAsAverageMonthlyGrowth", "createdAt", "updatedAt"],
  WishlistItemUpdateWithoutUserInput: ["id", "itemName", "priceInThousands", "price", "createdAt", "updatedAt"],
  ...
  NhFavoriteUpdateWithoutUserInput: ["url", "author"],
  NhAuthorUpdateWithoutUserInput: ["url", "checkedAt", "createdAt", "updatedAt", "favorites"],
  ...
  NhFavoriteCreateManyAuthorInput: ["url", "userId"],
  NhFavoriteUpdateWithoutAuthorInput: ["url", "user"]
};
