...
const modelsInfo = {
  ...
  Recipe: ["id", "userId", "title", "description", "rating", "createdAt", "updatedAt"],
...
const outputsInfo = {
  ...
  RecipeGroupBy: ["id", "userId", "title", "description", "rating", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  RecipeCountAggregate: ["id", "userId", "title", "description", "rating", "createdAt", "updatedAt", "_all"],
  RecipeAvgAggregate: ["rating"],
  RecipeSumAggregate: ["rating"],
  RecipeMinAggregate: ["id", "userId", "title", "description", "rating", "createdAt", "updatedAt"],
  RecipeMaxAggregate: ["id", "userId", "title", "description", "rating", "createdAt", "updatedAt"],
...
const inputsInfo = {
  ...
  RecipeWhereInput: ["AND", "OR", "NOT", "id", "userId", "user", "title", "description", "rating", "createdAt", "updatedAt"],
  RecipeOrderByWithRelationInput: ["id", "userId", "user", "title", "description", "rating", "createdAt", "updatedAt"],
  RecipeWhereUniqueInput: ["id"],
  RecipeOrderByWithAggregationInput: ["id", "userId", "title", "description", "rating", "createdAt", "updatedAt", "_count", "_avg", "_max", "_min", "_sum"],
  RecipeScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "userId", "title", "description", "rating", "createdAt", "updatedAt"],
  ...
  RecipeCreateInput: ["id", "user", "title", "description", "rating", "createdAt", "updatedAt"],
  RecipeUpdateInput: ["id", "user", "title", "description", "rating", "createdAt", "updatedAt"],
  RecipeCreateManyInput: ["id", "userId", "title", "description", "rating", "createdAt", "updatedAt"],
  RecipeUpdateManyMutationInput: ["id", "title", "description", "rating", "createdAt", "updatedAt"],
  ...
  RecipeCountOrderByAggregateInput: ["id", "userId", "title", "description", "rating", "createdAt", "updatedAt"],
  RecipeAvgOrderByAggregateInput: ["rating"],
  RecipeMaxOrderByAggregateInput: ["id", "userId", "title", "description", "rating", "createdAt", "updatedAt"],
  RecipeMinOrderByAggregateInput: ["id", "userId", "title", "description", "rating", "createdAt", "updatedAt"],
  RecipeSumOrderByAggregateInput: ["rating"],
  ...
  RecipeCreateWithoutUserInput: ["id", "title", "description", "rating", "createdAt", "updatedAt"],
  ...
  RecipeScalarWhereInput: ["AND", "OR", "NOT", "id", "userId", "title", "description", "rating", "createdAt", "updatedAt"],
  ...
  RecipeCreateManyUserInput: ["id", "title", "description", "rating", "createdAt", "updatedAt"],
  CurrentSavingCreateManyUserInput: ["id", "value", "createdAt", "updatedAt"],
  RecipeUpdateWithoutUserInput: ["id", "title", "description", "rating", "createdAt", "updatedAt"],
